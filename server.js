...
const ytdlCookieService = createYtdlCookieService({
  dataDir: DATA_DIR,
  defaultCookiesFile: DEFAULT_YTDL_COOKIES_FILE,
  cookiesFile: serverPlayerYtdlCookiesFile,
  cookiesFileFromEnv: serverPlayerYtdlCookiesFileFromEnv,
  cookieProbeUrl: serverPlayerYtdlCookieProbeUrl,
  expiryWarningDays: serverPlayerYtdlCookieExpiryWarningDays,
  ytdlFormat: serverPlayerYtdlFormat,
  ytdlJsRuntime: serverPlayerYtdlJsRuntime,
  attachComputedFields,
  cookieProbeCandidate: () => audioReplacementService.cookieProbeCandidate?.(),
...
function ytdlCookiesConfigured() {
  return ytdlCookieService.cookiesConfigured();
}
...
function ytdlCookiesFileIfAvailable() {
  return ytdlCookieService.cookiesFileIfAvailable();
}

function ytdlCookieStatus() {
  return ytdlCookieService.cookieStatus();
}
...
async function probeYtdlCookies(payload = {}) {
  return ytdlCookieService.probeCookies(payload);
}

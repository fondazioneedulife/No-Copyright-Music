...
| --- | --- | --- |
| `youtube-age-or-login` | YouTube richiede login, cookie, conferma eta o verifica anti-bot. | Configura `CLEARWAVE_YTDL_COOKIES_FILE` con cookie validi oppure sostituisci la traccia con una sorgente pubblica. |
